...
Recommends: awscli, awstats, bsdutils, certbot, etckeeper, fail2ban, fcgiwrap, firewalld, libconfig-inifiles-perl, libdbd-mysql-perl, libjson-xs-perl, liblog-log4perl-perl, libxml-simple-perl, lm-sensors, logrotate, mariadb-client | mysql-client, mariadb-common | mysql-common, mariadb-server | mysql-server, p7zip, parted, perl-doc, perl-modules, php-cgi, php-cli, php-curl, php-fpm, php-gd, php-json, php-mbstring, php-mysql, php-xml, python3, quota, rsync, shared-mime-info, sudo, unzip, usermin, webmin-virtualmin-awstats, webmin-virtualmin-htpasswd, xz-utils, zip
