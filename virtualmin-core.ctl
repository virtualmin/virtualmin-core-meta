...
Depends: libcrypt-ssleay-perl, libjson-pp-perl, openssl, webmin
Recommends: awscli, awstats, bind9-utils, bsdutils, certbot, etckeeper, fail2ban, fcgiwrap, firewalld, jailkit, libconfig-inifiles-perl, libdbd-mysql-perl, libjson-xs-perl, liblog-log4perl-perl, libxml-simple-perl, lm-sensors, logrotate, mariadb-client | mysql-client, mariadb-common | mysql-common, mariadb-server | mysql-server, p7zip, parted, perl-doc, perl-modules, php-cgi, php-cli, php-curl, php-fpm, php-gd, php-json, php-mbstring, php-mysql, php-xml, python3, quota, rsync, shared-mime-info, sudo, unzip, webmin-jailkit, webmin-virtualmin-awstats, webmin-virtualmin-htpasswd, xz-utils, zip
